...
import { ClientDetail } from "@/app/types/management/client";

const RegisterClient = ({ onModalVisible }: { onModalVisible: () => void }) => {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.headerContainer}>
        ...
        <TouchableOpacity onPress={onModalVisible} style={styles.closeIcon}>
